...
public class PersonalTrainingSession {
    ...
    public PersonalTrainingSession(int member_id, int trainer_id, Date session_date, PGInterval duration, Timestamp startTime, Timestamp endTime) {
